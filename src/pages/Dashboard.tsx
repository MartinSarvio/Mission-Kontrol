...
import { useGatewayPing, PingStatus } from '../hooks/useGatewayPing'
  ...
  return (
    <Card className="mb-8">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
          <span
            ...
            style={{
              ...
              borderRadius: '50%',
              background: dotColor,
              // CSS custom property til shadow-farve i keyframe
              ['--pulse-color' as any]: dotColor,
            }}
          />
        ...
        {/* Min / Maks / Gns — kun hvis nok data */}
        {history.length >= 3 && (() => {
